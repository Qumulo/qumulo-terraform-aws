...
# Deploying Cloud Native Qumulo (CNQ) on AWS with Terraform [![Latest Release](https://img.shields.io/github/release/qumulo/qumulo-terraform-aws)](https://github.com/qumulo/qumulo-terraform-aws/releases)
